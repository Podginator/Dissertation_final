...
public class Start {
    ...
    public static void main(String[] args) {
        ...
        DataSetExporter export = new DataSetExporter("easyTechHardBusinnessThree", techBus);
        export.export(System.getProperty("user.dir") + "/dataset");

        MultiLayerPerceptron_ArticleClassifier classifier = new MultiLayerPerceptron_ArticleClassifier("easyTechHardBusinnessThree");
